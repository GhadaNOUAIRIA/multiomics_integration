...
miRNA <- miRNA %>% 
  ...
  dplyr::slice(1:33)
miRNA <- miRNA[,-nearZeroVar(miRNA, uniqueCut = 30)] # cuts 1920 miRNA (hairpin = 943, mature = 977) 
...
metabolites <- metabolites %>% 
  ...
  log2() %>% 
  dplyr::slice(1:33)
metabolites <- metabolites[,-nearZeroVar(metabolites, uniqueCut = 30)] # cuts 28 metabolites
