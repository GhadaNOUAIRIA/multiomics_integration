...
pd1 <- metadata %>% 
  ...
  select(cca_binary, crohn_or_uc, ibd_binary, alp, alp_binary, bilirubin, bilirubin_binary, fibrosis_binary, sex, age, age_cat, bmi, bmi_cat, crp, IgG, IgA, group, auto_anb, alat, overlap_aih, steroids_other_medic, jaudice, pruritis, fever_chill, fatigue, no_symptoms) %>%
  as.data.frame()
