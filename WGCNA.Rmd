...
```{r miRNA_filter_data}
####USE THIS IF YOU WANT TO REMOVE CLUSTERS##########
...
###IF cluster were removed, The metadata need to be matched to the main cluster that was kept and it is referred to as fmetadata.
