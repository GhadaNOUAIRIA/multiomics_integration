...
# 
# test.keepX <- list(
#                    miRNA = c(5:9, seq(10, 100, 10)),
#                    proteins = c(5:9, seq(10, 100, 10)),
#                    metabolites = c(5:9, seq(10, 100, 10))
#                   )
# 
# # Tuning with loo-crossvalidation, i.e. choosing the variables to keep
# 
# start <- Sys.time()
# tune.diablo <- tune.block.splsda(X_train, alp_train, ncomp = ncomp,
...
#                    proteins = c(5:9, seq(10, 110, 20)),
#                    metabolites = c(5:9, seq(10, 110, 20))
#                   )
# 5, 50; 30, 110; 6, 5
```
...
# cimDiablo(fibrosis_diablo, color.blocks = c('darkorchid', 'brown1', 'lightgreen'),
#           comp = 1, margin=c(8,20), legend.position = "right", 
#           save = 'png', name.save = 'fibrosis_cim')
```
...
setwd("~/R/FoLäk2")
write_csv(variables, "results/mixOmics/mixOmics_fibrosis_binary.csv")
```
